...
### **Red Phase - Failed test for 'listAllBorrowedBooks()'**
This test will fail because listAllBorrowedBooks() is not yet implemented! 
...
### **Green Phase - Implement listAllBorrowedBooks()**
In report.js, we add this method to pass the test
...
### **Refactor Phase - Improvement of listAllBorrowedBooks()**
In report.js, let's improve it to ensure accurate validations.
